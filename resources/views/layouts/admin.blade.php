...
<body class="bg-gray-100 text-gray-900">
    ...
    <div class="min-h-screen flex">
        <!-- Sidebar -->
        <aside class="w-64 bg-yellow-600 text-black flex flex-col p-4 space-y-6 fixed h-full">
  ...
  <path stroke-linecap="round" stroke-linejoin="round"
        d="M12 6c0-1.1-.9-2-2-2H5a2 2 0 00-2 2v13a1 1 0 001.45.89L10 18.118M12 6c0-1.1.9-2 2-2h5a2 2 0 012 2v13a1 1 0 01-1.45.89L14 18.118M12 6v12" />
                ...
                <a href="{{ route('admin.settings.index') }}" class="hover:bg-yellow-700 p-2 rounded flex items-center">
                    <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0a1.724 1.724 0 002.592.93c.85-.49 1.91.37 1.41 1.23a1.724 1.724 0 00.93 2.592c.921.3.921 1.603 0 1.902a1.724 1.724 0 00-.93 2.592c.5.86-.56 1.72-1.41 1.23a1.724 1.724 0 00-2.592.93c-.3.921-1.603.921-1.902 0a1.724 1.724 0 00-2.592-.93c-.85.49-1.91-.37-1.41-1.23a1.724 1.724 0 00-.93-2.592c-.921-.3-.921-1.603 0-1.902a1.724 1.724 0 00.93-2.592c-.5-.86.56-1.72 1.41-1.23a1.724 1.724 0 002.592-.93z" />
